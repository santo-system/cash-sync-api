...
migration: ##@TYPEORM Generate migration
	npm run migration:generate libs/too-billing-core-database/src/migrations/migration

migration-run: ##@TYPEORM Generate and run migration
	- npm run migration:generate libs/too-billing-core-database/src/migrations/migration
...
docker-refresh: ##@DOCKER Stop the development environment, clean up volumes, start the development environment, run migrations on fresh database
	- docker compose down --volumes
	- docker compose build --no-cache
	- docker compose up
	- npm run migration:generate libs/too-billing-core-database/src/migrations/migration
